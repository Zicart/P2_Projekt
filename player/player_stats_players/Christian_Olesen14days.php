...
?>
 ...
 <div id="Content" class="flex-container-center" style="margin-top: 15px;">
        <div id="divA" >
            ...
            <div id="info">
            <p>Christian Olesen <br> 20 &aring;r <br><br> Tr&oslash;je nr.: 27 <br><br> Position: Goal keeper</p>  
            </div>
            <div id="description">
        ...
        <div id="divB">
         <button type="button" onclick="location.href='Christian_Olesen7days.php'">7 Dage</button>
		   <button type="button" onclick="location.href='Christian_Olesen14days.php'">14 Dage</button>
		   <button type="button" onclick="location.href='Christian_Olesen1month.php'">1 M&aring;ned</button>
		   <button type="button" onclick="location.href='Christian_Olesenalltime.php'">Altid</button>
