...
$p->data = array(array(array('Fremm&oslash;de', 4),array('Udeblev', 0), array('Meldt afbud', 0)));
$p->chart_type = "pie";
 ...
 <div id="Content" class="flex-container-center" style="margin-top: 15px;">
        <div id="divA" >
            <div id="picture" >
             ...
             <div id="info">
            <p>Simon Frederiksen <br> 21 &aring;r <br><br> Tr&oslash;je nr.: 23 <br><br> Position: Goal keeper</p>  
            </div>
            <div id="description">
        ...
        <div id="divB">
           <button type="button" onclick="location.href='Simon_Frederiksen7days.php'">7 Dage</button>
		   <button type="button" onclick="location.href='Simon_Frederiksen14days.php'">14 Dage</button>
		   <button type="button" onclick="location.href='Simon_Frederiksen1month.php'">1 M&aring;ned</button>
		   <button type="button" onclick="location.href='Simon_Frederiksenalltime.php'">Altid</button>
