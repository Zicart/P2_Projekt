...
<div style="margin: auto; display:flex; align-items:center; justify-content:center;">
		<button type="button" onclick="location.href='coach_statistics.php'">7 Dage</button>
		<button type="button" onclick="location.href='coach_statistics14days.php'">14 Dage</button>
		<button type="button" onclick="location.href='coach_statistics1month.php'">1 M&aring;ned</button>
		<button type="button" onclick="location.href='coach_statisticsalltime.php'">Altid</button>
		</div>
	<br>
	
<table class="ex2" cellspacing="10">
  <tr>
    <td style="border: 1px solid #000; text-align: center;">Kampe Spillet <br> 5</td>
  ...
  <tr>
	...
	<td style="border: 1px solid #000; text-align: center;">Holdfremm&oslash;de <br> 82%</td>
  </tr>
  <tr>
