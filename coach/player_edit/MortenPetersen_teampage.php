<?php
    ...
    */
    ...
    //********************** FREMSØG ALLE RÆKKER **********************
       ...
       $fetch_query = "SELECT * FROM users WHERE name='Morten Petersen'";   //HER HER HER HER HER HER HER HER HER HER//
...
<div id="Contents" class="flex-container-center" style="margin-top: 15px;">
        ...
        <div id="divBs">
					<div style="float: right;">	
                        <form name="edit" action="MortenPetersen_teampageedit.php" method="post"> <!-- HER HER HER HER HER HER HER HER   -->
