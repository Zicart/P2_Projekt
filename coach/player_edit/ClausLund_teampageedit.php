<?php
    ...
    if(isset($_POST['saved'])){
        ...
        header( 'Location: ClausLund_teampage.php' ) ;  //HEr HER HER HER HER HER HER HER HER HER
       }
    ...
    //********************** FREMSØG RÆKKE MED VALGT BRUGER **********************
       ...
       $fetch_query = "SELECT * FROM users WHERE name='Claus Lund'"; //HER HER HER HER HER HER HER HER
...
<div id="Contents" class="flex-container-center" style="margin-top: 15px;">
        ...
        <div id="divBs">
			 <form action="ClausLund_teampageedit.php" method="post">  <!-----HER HER HER HER HER HER HER HER HER HER HER HER --->
