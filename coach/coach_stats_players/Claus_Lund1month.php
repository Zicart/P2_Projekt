...
?>
 ...
 <div id="Content" class="flex-container-center" style="margin-top: 15px;">
        <div id="divA" >
          ...
          <div id="info">
            <p>Claus Lund <br> 21 &aring;r <br><br> Tr&oslash;je nr.: 23 <br><br> Position: Goal keeper</p>  
            </div>
            <div id="description">
        ...
        <div id="divB">
           <button type="button" onclick="location.href='Claus_Lund7days.php'">7 Dage</button>
		   <button type="button" onclick="location.href='Claus_Lund14days.php'">14 Dage</button>
		   <button type="button" onclick="location.href='Claus_Lund1month.php'">1 M&aring;ned</button>
		   <button type="button" onclick="location.href='Claus_Lundalltime.php'">Altid</button>
