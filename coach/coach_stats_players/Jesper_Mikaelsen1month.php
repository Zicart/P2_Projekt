...
?>
 ...
 <div id="Content" class="flex-container-center" style="margin-top: 15px;">
        <div id="divA" >
            ...
            <div id="info">
            <p>Jesper Mikaelsen <br> 21 &aring;r <br><br> Tr&oslash;je nr.: 23 <br><br> Position: Goal keeper</p>  
            </div>
            <div id="description">
        ...
        <div id="divB">
           <button type="button" onclick="location.href='Jesper_Mikaelsen7days.php'">7 Dage</button>
		   <button type="button" onclick="location.href='Jesper_Mikaelsen14days.php'">14 Dage</button>
		   <button type="button" onclick="location.href='Jesper_Mikaelsen1month.php'">1 M&aring;ned</button>
		   <button type="button" onclick="location.href='Jesper_Mikaelsenalltime.php'">Altid</button>
