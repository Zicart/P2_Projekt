...
?>
 ...
 <div id="Content" class="flex-container-center" style="margin-top: 15px;">
        <div id="divA" >
            <div id="picture" >
             <img src="\P2_Projekt\images\playerimage.png" id="picture">   
              ...
              <div id="info">
            <p>Morten Petersen <br> 21 &aring;r <br><br> Tr&oslash;je nr.: 23 <br><br> Position: Goal keeper</p>  
            </div>
            <div id="description">
        ...
        <div id="divB">
           <button type="button" onclick="location.href='Morten_Petersen7days.php'">7 Dage</button>
		   <button type="button" onclick="location.href='Morten_Petersen14days.php'">14 Dage</button>
		   <button type="button" onclick="location.href='Morten_Petersen1month.php'">1 M&aring;ned</button>
		   <button type="button" onclick="location.href='Morten_Petersenalltime.php'">Altid</button>
